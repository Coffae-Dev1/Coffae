...
function ProductMedia({ finish, fabric, variant = 'photo' }) {
  ...
  // walnut and birch have ottoman-color tab-2 images; oak not yet available
  const hasOttomanPhoto2 = ottomanSwap && (key === 'walnut' || key === 'birch');
      ...
      <div className="product-left">
        ...
        <div className="view-tabs">
          {[
            ...
            { key: 'photo2', img: fabric !== 'Charcoal' && (finish === 'Walnut' || finish === 'Birch') ? `assets/${finish.toLowerCase()}-${fabric.toLowerCase()}-2.png` : `assets/${finish.toLowerCase()}-2.png` },
...
const WOOD_FINISHES = [
  {
    ...
    detail: [
      { label: 'Origin', value: 'Eastern United States — sustainably harvested from FSC-certified forests in Pennsylvania, Ohio, and West Virginia.' },
      { label: 'Grain', value: 'Tight, straight, with occasional curl. Heartwood ranges from rich chocolate to a warm, purplish-brown that mellows toward honey at the edges.' },
      { label: 'Density', value: '610 kg/m³ — heavy enough to feel grounded, light enough to move on your own.' },
      { label: 'Finish', value: 'Hand-rubbed natural oil and hard wax. Food-safe, water-resistant, repairable. No sprays, no plastics.' },
      { label: 'Patina', value: 'Walnut warms with sunlight. Within six months the surface deepens by half a tone; within two years it settles into the colour you’ll keep.' },
      { label: 'Care', value: 'Dust with a dry cloth. For spills, wipe immediately and re-oil yearly with the kit included in your first shipment.' },
    ],
  },
  {
    key: 'oak',
    ...
    detail: [
      { label: 'Origin', value: 'Slow-growth white oak from PEFC-certified woodland in Poland and Germany.' },
      { label: 'Grain', value: 'Open, expressive grain with prominent medullary rays. Pale honey base with subtle olive undertones.' },
      { label: 'Density', value: '720 kg/m³ — the densest of our three. Dimensionally stable across humid and dry climates.' },
      { label: 'Finish', value: 'White-pigmented hardwax oil. Preserves the natural pale tone and resists yellowing over time.' },
      { label: 'Patina', value: 'Oak holds its colour longer than walnut. Expect a slow, even amber shift over five-plus years.' },
      { label: 'Care', value: 'Re-oil every 12–18 months. Open-grain pores accept repair beautifully — small dents lift with a damp cloth and an iron.' },
    ],
  },
  {
    key: 'birch',
    ...
    detail: [
      { label: 'Origin', value: 'Multi-ply Baltic birch from FSC-certified mills in Latvia and Estonia. Rotary-cut, void-free, 13 ply.' },
      { label: 'Grain', value: 'Fine, even grain with the occasional small knot left visible — never filled. Almost porcelain in tone.' },
      { label: 'Density', value: '670 kg/m³. Stiff and stable; the cleanest face for joinery.' },
      { label: 'Finish', value: 'Clear hardwax oil with UV inhibitor — keeps the pale, near-blonde colour from yellowing.' },
      { label: 'Patina', value: 'The most stable of the three. Birch barely ages, which is the point — for rooms that already have enough warmth.' },
      { label: 'Care', value: 'Wipe with a damp cloth. Re-oil every two years. Sand and re-finish lightly if you ever need a reset.' },
    ],
  },
];
...
const GLASS_OPTIONS = [
  {
    ...
    detail: [
      { label: 'Material', value: 'Low-iron tempered glass — virtually colourless, 91% light transmission. Made in Northern Italy.' },
      { label: 'Thickness', value: '10mm. Heavy enough to read as a real, structural surface; thin enough to feel like air on top of the wood.' },
      { label: 'Edge', value: 'Flat-polished and lightly chamfered. Soft to the touch, no sharp lines, safe with bare hands and small fingers.' },
      { label: 'Inset', value: 'Recessed 6mm into the walnut frame so the surface sits flush — no lip, no proud edge, no dust trap.' },
      { label: 'Frame', value: 'American Walnut shown here. The tempered glass is interchangeable across all three wood finishes.' },
      { label: 'Care', value: 'Wipe with a microfibre cloth. Avoid abrasive cleaners. Replacement panes ship pre-cut and tempered if you ever need one.' },
    ],
  },
  {
    key: 'birch',
    ...
    meta: ['10mm · CE', 'Low-iron · Tempered'],
    detail: [
      { label: 'Material', value: 'Identical 10mm low-iron tempered pane — only the frame changes. The pale birch lets the green-blue edge of the glass read more clearly.' },
      { label: 'Thickness', value: '10mm. The clearest expression of the joint between glass and wood when paired with light-coloured ply.' },
      { label: 'Edge', value: 'Flat-polished and lightly chamfered. Soft to the touch.' },
      { label: 'Inset', value: 'Recessed 6mm into the birch frame so the surface sits flush.' },
      { label: 'Frame', value: 'Baltic Birch shown here — the most studio-modern of the three.' },
      { label: 'Care', value: 'Wipe with a microfibre cloth. Avoid abrasive cleaners.' },
    ],
  },
  {
    key: 'oak',
    ...
    meta: ['10mm · CE', 'Low-iron · Tempered'],
    detail: [
      { label: 'Material', value: 'Same 10mm low-iron tempered pane. On darker oak, the glass reads almost as a void — light passes straight through.' },
      { label: 'Thickness', value: '10mm. Built to take a coffee mug, a book, a foot — repeatedly.' },
      { label: 'Edge', value: 'Flat-polished and lightly chamfered.' },
      { label: 'Inset', value: 'Recessed 6mm into the oak frame so the surface sits flush.' },
      { label: 'Frame', value: 'European Oak shown here, in our deepest stain.' },
      { label: 'Care', value: 'Wipe with a microfibre cloth. Avoid abrasive cleaners.' },
    ],
  },
];
...
const FABRIC_OPTIONS = [
  {
    ...
    detail: [
      { label: 'Yarn', value: 'Slubbed worsted wool spun against natural Belgian linen — lends the dark colour a depth you can read up close, never flat.' },
      { label: 'Weave', value: 'Loose basketweave at 18 threads / cm. Just open enough to catch light without trapping crumbs.' },
      { label: 'Tone', value: 'Reads as warm anthracite indoors, edges toward deep walnut-brown in afternoon light.' },
      { label: 'Pairs with', value: 'Walnut and oak frames especially well. The most forgiving of the four if you live with pets or red wine.' },
      { label: 'Care', value: 'Removable zip-cover, machine-washable cold. Air-dry flat. Spot-clean with mild soap and warm water.' },
      { label: 'Wear', value: 'Tested to 60,000 Martindale rubs — well past the threshold for heavy domestic use.' },
    ],
  },
  {
    key: 'rust',
    ...
    meta: ['68% wool · 32% linen', 'Woven in Portugal'],
    detail: [
      { label: 'Yarn', value: 'Plant-dyed wool — madder root and a touch of iron to settle the colour into a true terracotta rather than orange.' },
      { label: 'Weave', value: 'Loose basketweave at 18 threads / cm; pronounced texture catches the rust-and-shadow tones beautifully.' },
      { label: 'Tone', value: 'Saturated, sun-baked terracotta. Reads almost coral in direct sun, deeper brick at dusk.' },
      { label: 'Pairs with', value: 'Walnut frames for warm-on-warm; striking against the paler Birch.' },
      { label: 'Care', value: 'Removable zip-cover, machine-washable cold. Like all natural dyes, keep out of prolonged direct sunlight.' },
      { label: 'Wear', value: 'Tested to 60,000 Martindale rubs. Plant dyes age slightly toward terracotta-rose over many years — beautifully.' },
    ],
  },
  {
    key: 'oat',
    ...
    meta: ['68% wool · 32% linen', 'Woven in Portugal'],
    detail: [
      { label: 'Yarn', value: 'Undyed Merino wool blended with raw flax — the colour you see is the natural colour of the fibre.' },
      { label: 'Weave', value: 'Open basketweave at 18 threads / cm. The lightest of the four; you can almost see the structure.' },
      { label: 'Tone', value: 'Warm oat — somewhere between bone and biscuit, never stark white.' },
      { label: 'Pairs with', value: 'Every wood. Especially good with Walnut for high contrast, or Birch for a tonal, monochrome look.' },
      { label: 'Care', value: 'Removable zip-cover, machine-washable cold. Treat spills immediately — the lightest colour shows the most.' },
      { label: 'Wear', value: 'Tested to 60,000 Martindale rubs. The natural lanolin in the wool repels minor spills more than you’d expect.' },
    ],
  },
  {
    key: 'moss',
    ...
    meta: ['68% wool · 32% linen', 'Woven in Portugal'],
    detail: [
      { label: 'Yarn', value: 'Plant-dyed wool — chlorophyll and walnut hull yield the muted, slightly grey-green tone.' },
      { label: 'Weave', value: 'Loose basketweave at 18 threads / cm. The texture mutes the green into something almost stony.' },
      { label: 'Tone', value: 'A grounded olive — earthier than sage, warmer than forest. Reads neutral against most rooms.' },
      { label: 'Pairs with', value: 'Walnut and Oak; especially compelling with the warmer wood tones.' },
      { label: 'Care', value: 'Removable zip-cover, machine-washable cold. Air-dry flat to keep the wool soft.' },
      { label: 'Wear', value: 'Tested to 60,000 Martindale rubs. Natural dyes shift very gently — typically toward a softer sage over a decade of use.' },
    ],
  },
];
